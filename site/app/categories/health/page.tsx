      ...
      <Container className="grid gap-6 py-8 lg:grid-cols-[1fr_300px]">
        <section className="space-y-6">
          <div className="rounded-lg border border-neutral-200 bg-white p-5 shadow-sm">
            ...
            <h1 className="mt-4 text-4xl font-bold leading-[44px]">Health Calculators</h1>
            <p className="mt-3 max-w-3xl text-base leading-6 text-neutral-600">
              Body, fitness, nutrition, and wellness calculators for fast private estimates.
              Calculators are free and remain available without an account.
            </p>
            <div className="mt-5 flex flex-wrap gap-2">
              <Badge variant="health">Body</Badge>
              <Badge variant="health">Fitness & Nutrition</Badge>
              <Badge variant="health">Wellness</Badge>
          ...
          <div className="rounded-lg border border-neutral-200 bg-white p-4 text-sm text-neutral-600 shadow-sm">
            Basic calculators run without login. Cross-device saving and advanced exports can become Pro features.
          </div>
        </section>
