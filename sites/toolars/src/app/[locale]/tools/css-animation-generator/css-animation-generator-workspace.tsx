  ...
  return (
    <AiLabWorkbenchShell artifactState={t("artifact.ready")} providerRoute={t("providerRoute")} runMode={t("runMode")} toolSlug="css-animation-generator">
      ...
      <main className="workspace-stack">
        ...
        <section className="workspace-panel"><h2>{t("previewTitle")}</h2><div style={{ animation: result.declaration.replace("animation: ", ""), background: "var(--surface-muted)", border: "1px solid var(--border)", borderRadius: 8, minHeight: 96 }} /></section>
