...
export function CssToTailwindConverterWorkspace() {
  ...
  const [result, setResult] = useState<ReturnType<typeof convertCssToTailwind> | null>(null);

  return (
    <AiLabWorkbenchShell artifactState={result ? t("artifact.ready") : t("emptyResult")} providerRoute={t("providerRoute")} runMode={t("runMode")} toolSlug="css-to-tailwind-converter">
