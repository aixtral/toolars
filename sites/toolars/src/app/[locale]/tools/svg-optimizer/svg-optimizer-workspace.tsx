...
const sampleSvg = "<svg viewBox=\"0 0 24 24\"><!-- note --><metadata>x</metadata><path d=\"M0 0\" /></svg>";
...
export function SvgOptimizerWorkspace() {
  ...
  const [result, setResult] = useState<SvgOptimizerResult>(optimizeSvg(sampleSvg, { removeComments: true, removeMetadata: true, collapseWhitespace: true }));

  return (
    <AiLabWorkbenchShell artifactState={t("artifact.ready")} providerRoute={t("providerRoute")} runMode={t("runMode")} toolSlug="svg-optimizer">
