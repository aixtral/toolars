        ...
        <section className="workspace-panel">
          <div className="workspace-section-title" style={{ marginTop: 0 }}>
            <div>
              ...
              <p className="tool-description">{result ? result.summary : "Run calculation to classify the reading."}</p>
            </div>
          ...
          <div className="llm-plan-callout">
            ...
            <span>
              <strong>{result?.reason ?? "Waiting for calculation"}</strong>
              <small>{result?.advice ?? "Calculate first to review the reference category."}</small>
            </span>
          </div>
        </section>
      </div>
