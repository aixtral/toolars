# Tasks: auth-db-production-design

Documentation-only pass. TDD exception: no production code changes.

## 0. Preparation

- [x] 0.1 Create feature branch `feat/auth-db-production-design`.
- [x] 0.2 Read CDC context, architecture, current iteration plan, preview auth,
  AI route, plan gates, and relevant Supabase official docs.
