# Tasks: billing-subscription-state-pass

Documentation-only pass. TDD exception: no production code changes.

## 0. Preparation

- [x] 0.1 Create feature branch `feat/billing-subscription-state-pass`.
- [x] 0.2 Read current billing helpers, billing route tests, plan gates, current
  iteration plan, and Lemon Squeezy official docs.
...
- [x] 2.1 Add `docs/architecture/BILLING-SUBSCRIPTION-STATE-DESIGN.md`.
  - Covers: R1-S1, R1-S2, R2-S1, R2-S2, R3-S1, R3-S2, R4-S1, R4-S2
- [x] 2.2 Cross-check Lemon Squeezy source URLs and confirm no unchecked assumptions remain.
