...
## 2. Red Phase
- [ ] 2.1 Add unit tests for default `/tools` and `/tools?search=mortgage`.
  - Files: `site/app/__tests__/tools-page.test.tsx`
  - Covers: R1-S1, R2-S1
- [ ] 2.2 Add E2E tests for query search and empty state.
  - Files: `site/e2e/search.spec.ts`
  - Covers: R2-S1, R2-S2
- [ ] 2.3 Run focused tests and record the expected failing result.

## 3. Green Phase
- [ ] 3.1 Implement `searchParams` handling in `site/app/tools/page.tsx`.
- [ ] 3.2 Render query summary, populated search input, and empty state.
...
- [ ] 4.3 Run browser smoke on `http://127.0.0.1:9088/tools?search=mortgage`.
